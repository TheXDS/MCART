...
namespace TheXDS.MCART.ViewModel
{
    ...
    /// </typeparam>
    public sealed class ValidationSource<TViewModel> : ValidationSource where TViewModel : IValidatingViewModel
    {
        /// <summary>
        ...
        /// </param>
        public ValidationSource(TViewModel npcSource) : base(npcSource)
        {
        }
        ...
        /// seleccionada.
        /// </returns>
        public IEnumerable<string> GetErrors(Expression<Func<TViewModel>> propertySelector)
        {
