...
public class ObjectsTest
{
    ...
    public void HasAttrTest_Enum()
    {
        ...
        Assert.False(TestEnum.Zero.HasAttr(out MCART.Attributes.DescriptionAttribute? z));
        Assert.True(TestEnum.One.HasAttr(out MCART.Attributes.DescriptionAttribute? o));
    ...
    {
        Assert.False(((object)TestEnum.Zero).HasAttr(out MCART.Attributes.DescriptionAttribute? z));
        Assert.True(((object)TestEnum.One).HasAttr(out MCART.Attributes.DescriptionAttribute? o));
        Assert.Null(z);
        Assert.IsAssignableFrom<MCART.Attributes.DescriptionAttribute>(o);
        Assert.AreEqual("One", o!.Value);
        ...
        Assert.True(new TestClass().HasAttr(out IdentifierAttribute? id));
