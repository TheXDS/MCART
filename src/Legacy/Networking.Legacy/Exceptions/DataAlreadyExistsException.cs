...
using static TheXDS.MCART.Networking.Legacy.Resources.Strings;
...
namespace TheXDS.MCART.Exceptions
{
    ...
    public class DataAlreadyExistsException : Exception
    {
        ...
        /// </summary>
        public DataAlreadyExistsException() : base(UidAlreadyExists)
        {
        }
        ...
        public DataAlreadyExistsException(string uid) : base(string.Format(UidXAlreadyExists, uid))
        {
        }
        ...
        public DataAlreadyExistsException(string uid, Exception inner) : base(string.Format(UidXAlreadyExists, uid), inner)
        {
        }
