...
namespace TheXDS.MCART.Exceptions
{
    ...
    public class MissingArgumentException : ArgumentException
    {
        ...
        /// <see cref="MissingArgumentException" />.
        /// </summary>
        public MissingArgumentException() : base(MissingArg)
        {
        }
        ...
        public MissingArgumentException(string argumentName) : base(string.Format(MissingXArg, argumentName))
        {
        }
        ...
        /// </param>
        public MissingArgumentException(Exception inner) : base(MissingArg, inner)
        {
        }
