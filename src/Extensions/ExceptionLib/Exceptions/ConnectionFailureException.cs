...
namespace TheXDS.MCART.Exceptions
{
    ...
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="ConnectionFailureException" />.
        /// </summary>
        public ConnectionFailureException() : base(CouldntConnect)
        {
        }
        ...
        public ConnectionFailureException(IPEndPoint offendingEndPoint) : base(
            string.Format(CouldntConnectTo, $"{offendingEndPoint.Address}:{offendingEndPoint.Port}"))
        {
        ...
        /// <param name="offendingEndPoint">End point.</param>
        /// <param name="message">Un <see cref="string" /> que describe a la excepción.</param>
        public ConnectionFailureException(IPEndPoint offendingEndPoint, string message) : base(message)
        {
            OffendingEndPoint = offendingEndPoint;
        }
        ...
        /// <param name="offendingEndPoint">End point.</param>
        /// <param name="inner"><see cref="Exception" /> que es la causa de esta excepción.</param>
        public ConnectionFailureException(IPEndPoint offendingEndPoint, Exception inner) : base(
            string.Format(CouldntConnectTo, $"{offendingEndPoint.Address}:{offendingEndPoint.Port}"), inner)
        {
            OffendingEndPoint = offendingEndPoint;
        }
        ...
        /// <param name="message">Un <see cref="string" /> que describe a la excepción.</param>
        /// <param name="inner"><see cref="Exception" /> que es la causa de esta excepción.</param>
        public ConnectionFailureException(IPEndPoint offendingEndPoint, string message, Exception inner) : base(message, inner)
        {
            OffendingEndPoint = offendingEndPoint;
        }
        ...
        /// <see cref="ConnectionFailureException" />.
        /// </summary>
        /// <param name="info">
