...
namespace TheXDS.MCART.Networking.Mrpc.Serializers
{
    ...
    /// <see cref="Guid"/>.
    /// </summary>
    public sealed class GuidSerializer : IDataSerializer<Guid>
    {
        /// <summary>
        ...
        /// especificado.
        /// </returns>
        public Guid Read(BinaryReader reader) => reader.ReadGuid();
        ...
        /// </param>
        public void Write(Guid value, BinaryWriter writer) => writer.Write(value);
    }
}
