...
namespace MCART.Types.TaskReporter
{
    ...
    public abstract class TaskReporterControl : UserControl, ITaskReporter
    {
        ...
        private static DependencyPropertyKey CancelPendingPropertyKey = DependencyProperty.RegisterReadOnly(
            nameof(CancelPending),
            typeof(bool),
            typeof(TaskReporterControl),
            new PropertyMetadata(false));
        private static DependencyPropertyKey OnDutyPropertyKey = DependencyProperty.RegisterReadOnly(
            nameof(OnDuty),
            typeof(bool),
            typeof(TaskReporterControl),
            new PropertyMetadata(false));
        private static DependencyPropertyKey StoppablePropertyKey = DependencyProperty.RegisterReadOnly(
            nameof(Stoppable),
            typeof(bool?),
            typeof(TaskReporterControl),
            new PropertyMetadata(null));
        private static DependencyPropertyKey TStartPropertyKey = DependencyProperty.RegisterReadOnly(
            nameof(TStart),
            typeof(DateTime),
            typeof(TaskReporterControl),
            new PropertyMetadata(default(DateTime)));
        private static DependencyPropertyKey TimedOutPropertyKey = DependencyProperty.RegisterReadOnly(
            nameof(TimedOut),
            typeof(bool),
            typeof(TaskReporterControl),
            new PropertyMetadata(false));
        private static DependencyPropertyKey CurrentProgressPropertyKey = DependencyProperty.RegisterReadOnly(
        ...
        private void Bgn(TimeSpan timeout, bool genTOutEx, bool ns)
        {
            if (OnDuty) throw new InvalidOperationException();
            genEx = genTOutEx;
