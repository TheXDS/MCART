...
``` VB
<SerializableAttribute>
Public NotInheritable Class PluginFinalizingEventArgs
	Inherits CancelEventArgs
```

The PluginFinalizingEventArgs type exposes the following members.
...
<a href="#pluginfinalizingeventargs-class">Back to Top</a>
