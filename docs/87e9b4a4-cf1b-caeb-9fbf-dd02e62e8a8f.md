# Colors.Melon Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Melon"\]
...
**C#**<br />
``` C#
public static Color Melon { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Melon As Color
	Get
```
