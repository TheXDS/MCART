# Strings.NotImplemented Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.NotImplemented"\]
...
**VB**<br />
``` VB
Public Const NotImplemented As String = "Función no implementada"
```
