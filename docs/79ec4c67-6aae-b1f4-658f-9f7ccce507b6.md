# Colors.RawSienna Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.RawSienna"\]
...
**C#**<br />
``` C#
public static Color RawSienna { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property RawSienna As Color
	Get
```
