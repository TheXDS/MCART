# Colors.SgiSlateBlue Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiSlateBlue"\]
...
**C#**<br />
``` C#
public static Color SgiSlateBlue { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiSlateBlue As Color
	Get
```
