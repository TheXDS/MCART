# Strings.ImplInterfaces Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.ImplInterfaces"\]
...
**VB**<br />
``` VB
Public Const ImplInterfaces As String = "Interfaces implementadas"
```
