# RemovedItemEventArgs(*T*) Class
 _**\[This is preliminary documentation and is subject to change.\]**_

Contiene información para el evento <a href="f2a2ab2a-f6fc-a406-a5a1-705688198b00">RemovedItem</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;MCART.Types.Extensions.RemovedItemEventArgs(T)<br />
...
**VB**<br />
``` VB
Public Class RemovedItemEventArgs(Of T)
	Inherits EventArgs
```
...
The RemovedItemEventArgs(T) type exposes the following members.
...
<a href="#removeditemeventargs(*t*)-class">Back to Top</a>
