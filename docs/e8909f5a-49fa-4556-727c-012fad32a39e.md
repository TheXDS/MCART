...
**VB**<br />
``` VB
Public Class ModifyingItemEventArgs(Of T)
...
The ModifyingItemEventArgs(T) type exposes the following members.
...
<a href="#modifyingitemeventargs(*t*)-class">Back to Top</a>
