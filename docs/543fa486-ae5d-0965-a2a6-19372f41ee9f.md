# Colors.ManganeseBlue Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.ManganeseBlue"\]
...
**C#**<br />
``` C#
public static Color ManganeseBlue { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property ManganeseBlue As Color
	Get
```
