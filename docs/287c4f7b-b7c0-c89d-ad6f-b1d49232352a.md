# Strings.PluginsInfo Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.PluginsInfo"\]
...
**VB**<br />
``` VB
Public Const PluginsInfo As String = "Información de plugins"
```
