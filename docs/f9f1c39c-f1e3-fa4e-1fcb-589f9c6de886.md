# Colors.SgiGray92 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray92"\]
...
**C#**<br />
``` C#
public static Color SgiGray92 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray92 As Color
	Get
```
