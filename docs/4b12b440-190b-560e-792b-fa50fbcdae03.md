# Strings.MandatoryField Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.MandatoryField"\]
...
**VB**<br />
``` VB
Public Const MandatoryField As String = "Este campo es obligatorio"
```
