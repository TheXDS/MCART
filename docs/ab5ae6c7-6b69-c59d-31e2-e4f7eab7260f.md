# Colors.IceWhite Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.IceWhite"\]
...
**C#**<br />
``` C#
public static Color IceWhite { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property IceWhite As Color
	Get
```
