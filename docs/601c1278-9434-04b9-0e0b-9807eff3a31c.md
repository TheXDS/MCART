# ProgressRing.SweepProperty Field
 _**\[This is preliminary documentation and is subject to change.\]**_

Identifica a la propiedad de dependencia <a href="28101aa9-139b-92eb-c75c-dbcb53758ff2">Sweep</a>.
...
**C#**<br />
``` C#
public static DependencyProperty SweepProperty
```

**VB**<br />
``` VB
Public Shared SweepProperty As DependencyProperty
```
