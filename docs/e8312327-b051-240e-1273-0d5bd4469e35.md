# BoolFlagConverter(*T*).ConvertBack Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Convierte un <a href="http://msdn2.microsoft.com/es-es/library/a28wyd50" target="_blank">Boolean</a> al tipo establecido para este <a href="20d8b90a-635b-e7e2-1da5-2f95a7df5a09">BoolFlagConverter(T)</a>.
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">Object</a><br />Si *value* es `true`, se devuelve la(s) bandera(s) a ser detectada(s), en caso de haberse establecido un valor para <a href="5b38e9e2-8ca1-df3c-318a-0aca029af056">True</a>, o en caso contrario, se devolverá `default(T)`.
