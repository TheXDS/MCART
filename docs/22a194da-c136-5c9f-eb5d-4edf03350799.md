# Colors.WoodYellow Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.WoodYellow"\]
...
**C#**<br />
``` C#
public static Color WoodYellow { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property WoodYellow As Color
	Get
```
