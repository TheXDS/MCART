# Colors.Sgiteal Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Sgiteal"\]
...
**C#**<br />
``` C#
public static Color Sgiteal { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Sgiteal As Color
	Get
```
