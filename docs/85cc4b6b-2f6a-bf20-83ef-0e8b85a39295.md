# Colors.SgiGray16 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray16"\]
...
**C#**<br />
``` C#
public static Color SgiGray16 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray16 As Color
	Get
```
