# Strings.StackUnderflow Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.StackUnderflow"\]
...
**VB**<br />
``` VB
Public Const StackUnderflow As String = "Subflujo de pila"
```
