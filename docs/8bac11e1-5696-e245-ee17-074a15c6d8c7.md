# Strings.PwNtbmc Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.PwNtbmc"\]
...
**VB**<br />
``` VB
Public Const PwNtbmc As String = "La contraseña debe ser más compleja."
```
