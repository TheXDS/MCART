...
Devuelve una cadena con el texto "✓ {*text*}".
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a><br />Una cadena con el texto "✓ {*text*}".

## Remarks
El texto generado por esta función podría no verse correctamente en un programa, consola o terminal que no sea Unicode.
