# Colors.BurntSienna Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.BurntSienna"\]
...
**C#**<br />
``` C#
public static Color BurntSienna { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property BurntSienna As Color
	Get
```
