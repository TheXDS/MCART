# Strings.PwdConfirm Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.PwdConfirm"\]
...
**VB**<br />
``` VB
Public Const PwdConfirm As String = "Confirme la contraseña"
```
