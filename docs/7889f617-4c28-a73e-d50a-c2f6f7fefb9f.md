...
**VB**<br />
``` VB
Public Class InsertingItemEventArgs(Of T)
...
The InsertingItemEventArgs(T) type exposes the following members.
...
<a href="#insertingitemeventargs(*t*)-class">Back to Top</a>
