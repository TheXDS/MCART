# TargetMCARTVersionAttribute Class
...
**VB**<br />
``` VB
Public NotInheritable Class TargetMCARTVersionAttribute
	Inherits VersionAttributeBase
```

The TargetMCARTVersionAttribute type exposes the following members.
...
<a href="#targetmcartversionattribute-class">Back to Top</a>
