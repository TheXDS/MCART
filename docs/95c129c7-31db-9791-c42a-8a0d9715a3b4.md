# InsertedItemEventArgs(*T*) Class
 _**\[This is preliminary documentation and is subject to change.\]**_

Contiene información para el evento <a href="d233a8b8-4dea-d766-1d11-c03dd225d158">InsertedItem</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;MCART.Types.Extensions.InsertedItemEventArgs(T)<br />
...
**VB**<br />
``` VB
Public Class InsertedItemEventArgs(Of T)
	Inherits EventArgs
```
...
The InsertedItemEventArgs(T) type exposes the following members.
...
<a href="#inserteditemeventargs(*t*)-class">Back to Top</a>
