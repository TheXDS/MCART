# Colors.Poop Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Poop"\]
...
**C#**<br />
``` C#
public static Color Poop { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Poop As Color
	Get
```
