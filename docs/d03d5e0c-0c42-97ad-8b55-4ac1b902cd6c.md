# Colors.CobaltGreen Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.CobaltGreen"\]
...
**C#**<br />
``` C#
public static Color CobaltGreen { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property CobaltGreen As Color
	Get
```
