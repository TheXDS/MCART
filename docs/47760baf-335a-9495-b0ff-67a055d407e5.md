...
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;System.Windows.Converters.MultiplyConverter(T)<br />
...
**C#**<br />
``` C#
public class MultiplyConverter<T> : IValueConverter
where T : struct, new()
...
**VB**<br />
``` VB
Public Class MultiplyConverter(Of T As {Structure, New})
...
Operando de multiplicación de este MultiplyConverter(T).</td></tr></table>&nbsp;
<a href="#multiplyconverter(*t*)-class">Back to Top</a>
