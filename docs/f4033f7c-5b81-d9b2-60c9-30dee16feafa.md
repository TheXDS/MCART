# Strings.InvalidData Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.InvalidData"\]
...
**VB**<br />
``` VB
Public Const InvalidData As String = "Los datos proporcionados no son válidos."
```
