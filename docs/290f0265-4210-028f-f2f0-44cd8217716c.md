# Strings.XNotSelected Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Devuelve una cadena con el texto "No se ha seleccionado {*text*}".
...
**C#**<br />
``` C#
public static string XNotSelected(
	string text
)
```
...
**VB**<br />
``` VB
Public Shared Function XNotSelected ( 
	text As String
) As String
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a><br />Una cadena con el texto "No se ha seleccionado {*text*}".
