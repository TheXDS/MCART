# Colors.IvoryBlack Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.IvoryBlack"\]
...
**C#**<br />
``` C#
public static Color IvoryBlack { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property IvoryBlack As Color
	Get
```
