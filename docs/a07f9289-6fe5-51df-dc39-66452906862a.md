# Colors.Banana Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Banana"\]
...
**C#**<br />
``` C#
public static Color Banana { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Banana As Color
	Get
```
