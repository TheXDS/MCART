# Colors.SgiLightBlue Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiLightBlue"\]
...
**C#**<br />
``` C#
public static Color SgiLightBlue { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiLightBlue As Color
	Get
```
