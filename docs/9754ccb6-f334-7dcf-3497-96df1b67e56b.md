# Colors.SgiGray96 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray96"\]
...
**C#**<br />
``` C#
public static Color SgiGray96 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray96 As Color
	Get
```
