# Colors.IronOxideGlass Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.IronOxideGlass"\]
...
**C#**<br />
``` C#
public static Color IronOxideGlass { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property IronOxideGlass As Color
	Get
```
