# Colors.SgiDarkGray Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiDarkGray"\]
...
**C#**<br />
``` C#
public static Color SgiDarkGray { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiDarkGray As Color
	Get
```
