# Colors.SapGreen Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SapGreen"\]
...
**C#**<br />
``` C#
public static Color SapGreen { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SapGreen As Color
	Get
```
