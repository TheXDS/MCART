# ItemModifiedEventArgs(*T*) Class
 _**\[This is preliminary documentation and is subject to change.\]**_

Contiene información para el evento <a href="472051a4-86ba-1895-11dc-4c2f01684f5b">ModifiedItem</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;MCART.Types.Extensions.ItemModifiedEventArgs(T)<br />
...
**VB**<br />
``` VB
Public Class ItemModifiedEventArgs(Of T)
	Inherits EventArgs
```
...
The ItemModifiedEventArgs(T) type exposes the following members.
...
<a href="#itemmodifiedeventargs(*t*)-class">Back to Top</a>
