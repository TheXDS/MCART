# BrushOpacityAdjust.ConvertBack Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Devuelve un <a href="http://msdn2.microsoft.com/es-es/library/ms634880" target="_blank">Brush</a> con 100% opacidad.
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">Object</a><br />Un nuevo <a href="http://msdn2.microsoft.com/es-es/library/ms634880" target="_blank">Brush</a> con la opacidad al 100%.
