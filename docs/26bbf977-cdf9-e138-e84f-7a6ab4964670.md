# Colors.SgibrightGray Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgibrightGray"\]
...
**C#**<br />
``` C#
public static Color SgibrightGray { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgibrightGray As Color
	Get
```
