...
Incluye información adicional del evento <a href="2c633ce3-ce6e-4368-045b-c54b3c4429ca">PluginLoaded</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;MCART.PluginSupport.PluginLoadedEventArgs<br />
...
``` VB
<SerializableAttribute>
Public NotInheritable Class PluginLoadedEventArgs
	Inherits EventArgs
```

The PluginLoadedEventArgs type exposes the following members.
...
<a href="#pluginloadedeventargs-class">Back to Top</a>
