# Colors.EggShell Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.EggShell"\]
...
**C#**<br />
``` C#
public static Color EggShell { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property EggShell As Color
	Get
```
