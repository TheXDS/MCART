# Colors.EmeraldGreen Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.EmeraldGreen"\]
...
**C#**<br />
``` C#
public static Color EmeraldGreen { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property EmeraldGreen As Color
	Get
```
