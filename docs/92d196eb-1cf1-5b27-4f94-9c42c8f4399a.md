# ToStringConverter.ConvertBack Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Intenta una conversión de <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a> a un objeto del tipo de destino especificado.
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">Object</a><br />Si la conversión desde <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a> tuvo éxito, se devolverá al objeto, se devolverá `null` en caso contrario.
