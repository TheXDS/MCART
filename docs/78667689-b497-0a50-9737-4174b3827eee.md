# IEasyCryptoPlugin Interface
 _**\[This is preliminary documentation and is subject to change.\]**_

Relaciona las interfaces de <a href="d3dabdec-6d8b-55d5-feb1-c57335b60e27">IEasyCrypto</a> y <a href="4ee0e2a7-cfcb-eb2f-49cb-5ac7500b7e3d">IPlugin</a> para crear un plugin compatible con MCART.
...
**C#**<br />
``` C#
public interface IEasyCryptoPlugin : IEasyCrypto, 
	IPlugin
```

**VB**<br />
``` VB
Public Interface IEasyCryptoPlugin
	Inherits IEasyCrypto, IPlugin
```

The IEasyCryptoPlugin type exposes the following members.
...
<a href="#ieasycryptoplugin-interface">Back to Top</a>
