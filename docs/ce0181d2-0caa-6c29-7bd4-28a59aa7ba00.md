# Strings.ClientConnected Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.ClientConnected"\]
...
**VB**<br />
``` VB
Public Const ClientConnected As String = "Se ha conectado un nuevo cliente."
```
