# Colors.Brick Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Brick"\]
...
**C#**<br />
``` C#
public static Color Brick { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Brick As Color
	Get
```
