# StringVisibilityConverter.ConvertBack Method 
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">Object</a><br />`value.ToString()` si *value* no es una cadena vacía, <a href="http://msdn2.microsoft.com/es-es/library/74wsya52" target="_blank">Empty</a> en caso contrario.
