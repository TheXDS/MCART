# Colors.SgiGray32 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray32"\]
...
**C#**<br />
``` C#
public static Color SgiGray32 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray32 As Color
	Get
```
