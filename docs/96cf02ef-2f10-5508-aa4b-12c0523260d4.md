# StreamExtensions.ReadStringToEndAsync Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Lee asíncronamente una cadena desde la posición actual hasta el final de la secuencia.
...
**C#**<br />
``` C#
public static Task<string> ReadStringToEndAsync(
	this Stream fs
)
```
...
``` VB
<ExtensionAttribute>
Public Shared Function ReadStringToEndAsync ( 
	fs As Stream
) As Task(Of String)
```
