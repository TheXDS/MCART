# Colors.CadmiumOrange Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.CadmiumOrange"\]
...
**C#**<br />
``` C#
public static Color CadmiumOrange { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property CadmiumOrange As Color
	Get
```
