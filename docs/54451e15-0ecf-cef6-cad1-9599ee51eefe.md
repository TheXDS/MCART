# Colors.SgiGray76 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray76"\]
...
**C#**<br />
``` C#
public static Color SgiGray76 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray76 As Color
	Get
```
