...
Incluye información de evento para cualquier clase con eventos de logging (bitácora).


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="99375f7a-b85c-b405-0819-7d2e3b04732b">MCART.Events.ValueEventArgs</a>(<a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MCART.Events.LoggingEventArgs<br />
...
Public Class LoggingEventArgs
	Inherits ValueEventArgs(Of String)
```

The LoggingEventArgs type exposes the following members.
...
Inicializa una nueva instancia de la clase LoggingEventArgs, sin definir un objeto relacionado.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="a7efb90a-626c-fdd1-9b42-315bdceda7f7">LoggingEventArgs(Object, String)</a></td><td>
Inicializa una nueva instancia de la clase LoggingEventArgs, definiendo un objeto relacionado.</td></tr></table>&nbsp;
<a href="#loggingeventargs-class">Back to Top</a>
