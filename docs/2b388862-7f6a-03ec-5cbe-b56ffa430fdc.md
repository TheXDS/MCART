# Colors.Sgibeet Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Sgibeet"\]
...
**C#**<br />
``` C#
public static Color Sgibeet { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Sgibeet As Color
	Get
```
