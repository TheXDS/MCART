# NavigationBar.DeletingEventHandler Delegate
 _**\[This is preliminary documentation and is subject to change.\]**_

Controla el evento <a href="0304dd9a-caa0-4bd8-3624-5f11df1546f1">Deleting</a>.
...
**C#**<br />
``` C#
public delegate void DeletingEventHandler(
	Object sender,
	CancelEventArgs e
)
```
...
**VB**<br />
``` VB
Public Delegate Sub DeletingEventHandler ( 
	sender As Object,
