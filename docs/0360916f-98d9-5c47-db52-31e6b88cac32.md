# UIChangeEventArgs Class
 _**\[This is preliminary documentation and is subject to change.\]**_

Incluye información adicional del evento <a href="43785423-5ff6-9a36-a667-3ff296860430">UIChangeRequested</a>


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;MCART.PluginSupport.UIChangeEventArgs<br />
...
**VB**<br />
``` VB
Public NotInheritable Class UIChangeEventArgs
	Inherits EventArgs
```

The UIChangeEventArgs type exposes the following members.
...
<a href="#uichangeeventargs-class">Back to Top</a>
