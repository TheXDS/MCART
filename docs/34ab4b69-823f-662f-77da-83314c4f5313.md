# Colors.SgiOlivedrab Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiOlivedrab"\]
...
**C#**<br />
``` C#
public static Color SgiOlivedrab { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiOlivedrab As Color
	Get
```
