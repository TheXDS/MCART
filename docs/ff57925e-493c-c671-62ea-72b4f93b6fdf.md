# AddedItemEventArgs(*T*) Class
 _**\[This is preliminary documentation and is subject to change.\]**_

Contiene información para el evento <a href="8a5f66f6-aa09-8605-109c-71cac6910150">AddedItem</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;MCART.Types.Extensions.AddedItemEventArgs(T)<br />
...
**VB**<br />
``` VB
Public Class AddedItemEventArgs(Of T)
	Inherits EventArgs
```
...
The AddedItemEventArgs(T) type exposes the following members.
...
<a href="#addeditemeventargs(*t*)-class">Back to Top</a>
