# Strings.invalidPluginClass Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.invalidPluginClass"\]
...
**VB**<br />
``` VB
Public Const invalidPluginClass As String = "La clase no es un Plugin válido."
```
