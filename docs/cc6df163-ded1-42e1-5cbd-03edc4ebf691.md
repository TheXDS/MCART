# Colors.SgiGray36 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray36"\]
...
**C#**<br />
``` C#
public static Color SgiGray36 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray36 As Color
	Get
```
