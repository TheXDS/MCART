# Colors.BurnTumber Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.BurnTumber"\]
...
**C#**<br />
``` C#
public static Color BurnTumber { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property BurnTumber As Color
	Get
```
