# LightGraph.xPeriodProperty Field
 _**\[This is preliminary documentation and is subject to change.\]**_

Identifica la propiedad de dependencia <a href="012b7a1d-fba0-63bd-755a-306a0cb898ff">XPeriod</a>.
...
**C#**<br />
``` C#
public static DependencyProperty xPeriodProperty
```

**VB**<br />
``` VB
Public Shared xPeriodProperty As DependencyProperty
```
