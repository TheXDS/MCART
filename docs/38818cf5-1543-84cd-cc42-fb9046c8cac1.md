# Strings.PluginXNeeded Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Devuelve una cadena con el texto "Se necesita un Plugin de tipo {*plg*}".
...
**C#**<br />
``` C#
public static string PluginXNeeded(
	string plg
)
```
...
**VB**<br />
``` VB
Public Shared Function PluginXNeeded ( 
	plg As String
) As String
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a><br />Una cadena con el texto "Se necesita un Plugin de tipo {*plg*}".
