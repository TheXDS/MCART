# Colors.MagicPurple Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.MagicPurple"\]
...
**C#**<br />
``` C#
public static Color MagicPurple { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property MagicPurple As Color
	Get
```
