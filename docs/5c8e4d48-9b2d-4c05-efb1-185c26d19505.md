# Colors.SgiGray56 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray56"\]
...
**C#**<br />
``` C#
public static Color SgiGray56 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray56 As Color
	Get
```
