# Colors.RacingYellow Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.RacingYellow"\]
...
**C#**<br />
``` C#
public static Color RacingYellow { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property RacingYellow As Color
	Get
```
