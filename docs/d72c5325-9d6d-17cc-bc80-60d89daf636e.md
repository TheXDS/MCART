# Strings.CantCreateInstance Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Devuelve una cadena con el texto "No se pudo crear una nueva instancia del tipo {*text*}".
...
**C#**<br />
``` C#
public static string CantCreateInstance(
	string text
)
```
...
**VB**<br />
``` VB
Public Shared Function CantCreateInstance ( 
	text As String
) As String
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a><br />Una cadena con el texto "No se pudo crear una nueva instancia del tipo {*text*}".
