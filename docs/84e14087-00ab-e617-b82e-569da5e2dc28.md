# FloatVisibilityConverter.ConvertBack Method 
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">Object</a><br />`1.0f` si *value* es igual a <a href="72e4a3c2-40f7-4284-aa09-b65c8f71be74">Positives</a>, `0.0f` en caso contrario.
