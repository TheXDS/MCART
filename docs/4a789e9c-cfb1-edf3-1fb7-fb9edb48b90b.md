# Colors.TurquoiseBlue Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.TurquoiseBlue"\]
...
**C#**<br />
``` C#
public static Color TurquoiseBlue { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property TurquoiseBlue As Color
	Get
```
