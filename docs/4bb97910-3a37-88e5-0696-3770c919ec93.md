# NotPluginException Class
 _**\[This is preliminary documentation and is subject to change.\]**_

Excepción que se produce al intentar cargar plugins desde un ensamblado que no contiene ninguno.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/es-es/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;MCART.Exceptions.NotPluginException<br />
...
``` VB
<SerializableAttribute>
Public Class NotPluginException
	Inherits Exception
```

The NotPluginException type exposes the following members.
...
Inicializa una nueva instancia de la clase NotPluginException.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="aba8374c-1c1e-5ea8-63f1-680194113974">NotPluginException(Exception, Assembly)</a></td><td>
Inicializa una nueva instancia de la clase NotPluginException.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="bbc79035-1605-7cbf-e07b-ead66453681d">NotPluginException(String, Assembly)</a></td><td>
Inicializa una nueva instancia de la clase NotPluginException.</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="330bc5f6-9b94-78c0-7deb-2d51cb808635">NotPluginException(SerializationInfo, StreamingContext, Assembly)</a></td><td>
...
Inicializa una nueva instancia de la clase NotPluginException.</td></tr></table>&nbsp;
<a href="#notpluginexception-class">Back to Top</a>
