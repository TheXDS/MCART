# Strings.CorruptData Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.CorruptData"\]
...
**VB**<br />
``` VB
Public Const CorruptData As String = "Se han recibido datos corruptos"
```
