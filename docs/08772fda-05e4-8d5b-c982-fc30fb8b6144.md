# Colors.Carrot Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Carrot"\]
...
**C#**<br />
``` C#
public static Color Carrot { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Carrot As Color
	Get
```
