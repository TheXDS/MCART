# Colors.Flesh Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Flesh"\]
...
**C#**<br />
``` C#
public static Color Flesh { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Flesh As Color
	Get
```
