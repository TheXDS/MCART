# Strings.FormatNotSupported Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Devuelve una cadena con el texto "El formato {*text*} no está soportado.".
...
**VB**<br />
``` VB
Public Shared Function FormatNotSupported ( 
	text As String
) As String
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a><br />Una cadena con el texto "El formato {*text*} no está soportado.".
