# Strings.PluginDidntInit Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.PluginDidntInit"\]
...
**VB**<br />
``` VB
Public Const PluginDidntInit As String = "El plugin no se inicializó"
```
