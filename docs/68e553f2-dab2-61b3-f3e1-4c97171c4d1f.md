# Strings.PluginInfo2 Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.PluginInfo2"\]
...
**VB**<br />
``` VB
Public Const PluginInfo2 As String = "El plugin es compatible con esta versión de MCART."
```
