# Colors.Peacock Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Peacock"\]
...
**C#**<br />
``` C#
public static Color Peacock { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Peacock As Color
	Get
```
