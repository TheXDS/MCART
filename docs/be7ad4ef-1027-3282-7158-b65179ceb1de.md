# Strings.DirectoryIsFull Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.DirectoryIsFull"\]
...
**VB**<br />
``` VB
Public Const DirectoryIsFull As String = "El directorio está lleno"
```
