...
Public Class ProgressionEventArgs
	Inherits ValueEventArgs(Of Double)
```

The ProgressionEventArgs type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="6ab507f2-c8ec-1656-75ef-f1e7a624c909">ProgressionEventArgs</a></td><td>
Inicializa una nueva instancia de este objeto con los datos provistos.</td></tr></table>&nbsp;
<a href="#progressioneventargs-class">Back to Top</a>
