# BusyIndicator.StartingProperty Field
 _**\[This is preliminary documentation and is subject to change.\]**_

Identifica a la propiedad de dependencia <a href="d9fbb218-a08d-e0bf-d6f0-e90d43b5c160">Starting</a>.
...
**C#**<br />
``` C#
public static DependencyProperty StartingProperty
```

**VB**<br />
``` VB
Public Shared StartingProperty As DependencyProperty
```
