# CountVisibilityConverter.ConvertBack Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Infiere una cuenta de elementos basado en el <a href="http://msdn2.microsoft.com/es-es/library/ms590101" target="_blank">Visibility</a> provisto.
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">Object</a><br />`1` si *value* es igual a <a href="18786240-7241-7fe4-4c6b-b097d19103a2">WithItems</a>, `0` en caso contrario.
