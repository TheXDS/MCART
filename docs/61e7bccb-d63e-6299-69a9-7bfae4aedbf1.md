# Strings.TheGraphView Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.TheGraphView"\]
...
**VB**<br />
``` VB
Public Const TheGraphView As String = "El controlador de gráficas"
```
