# Colors.SgiGray72 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray72"\]
...
**C#**<br />
``` C#
public static Color SgiGray72 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray72 As Color
	Get
```
