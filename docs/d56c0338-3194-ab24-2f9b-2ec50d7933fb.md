# NavigationBar.CancelledEventHandler Delegate
 _**\[This is preliminary documentation and is subject to change.\]**_

Controla el evento <a href="89e26938-02e9-93cb-cc06-ba364eb1f46f">Cancelled</a>.
...
**VB**<br />
``` VB
Public Delegate Sub CancelledEventHandler ( 
	sender As Object,
	e As EventArgs
)
```
