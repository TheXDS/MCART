# Strings.FeatNotAvailable Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.FeatNotAvailable"\]
...
**VB**<br />
``` VB
Public Const FeatNotAvailable As String = "Característica no disponible"
```
