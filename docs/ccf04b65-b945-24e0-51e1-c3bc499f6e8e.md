# Colors.SgiSalmon Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiSalmon"\]
...
**C#**<br />
``` C#
public static Color SgiSalmon { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiSalmon As Color
	Get
```
