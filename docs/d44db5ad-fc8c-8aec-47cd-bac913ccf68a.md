# Colors.WarmGrey Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.WarmGrey"\]
...
**C#**<br />
``` C#
public static Color WarmGrey { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property WarmGrey As Color
	Get
```
