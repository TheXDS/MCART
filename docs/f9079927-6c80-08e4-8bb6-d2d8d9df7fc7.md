# Colors.Sepia Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Sepia"\]
...
**C#**<br />
``` C#
public static Color Sepia { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Sepia As Color
	Get
```
