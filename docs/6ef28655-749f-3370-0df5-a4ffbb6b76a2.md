# Strings.InvalidInfo Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.InvalidInfo"\]
...
**VB**<br />
``` VB
Public Const InvalidInfo As String = "La información no es válida."
```
