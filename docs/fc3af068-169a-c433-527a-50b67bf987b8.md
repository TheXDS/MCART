# Strings.XNotCancellable Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Devuelve una cadena con el texto "{*text*} no es cancelable".
...
**C#**<br />
``` C#
public static string XNotCancellable(
	string text
)
```
...
**VB**<br />
``` VB
Public Shared Function XNotCancellable ( 
	text As String
) As String
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/s1wwdcbf" target="_blank">String</a><br />Una cadena con el texto "{*text*} no es cancelable".
