# Colors.Raspberry Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Raspberry"\]
...
**C#**<br />
``` C#
public static Color Raspberry { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Raspberry As Color
	Get
```
