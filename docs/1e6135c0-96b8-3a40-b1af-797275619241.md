# Colors.SgiLightGray Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiLightGray"\]
...
**C#**<br />
``` C#
public static Color SgiLightGray { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiLightGray As Color
	Get
```
