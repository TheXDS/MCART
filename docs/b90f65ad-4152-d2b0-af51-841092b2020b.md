# Strings.NotEnoughData Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:MCART.Resources.Strings.NotEnoughData"\]
...
**VB**<br />
``` VB
Public Const NotEnoughData As String = "Los datos son insuficientes"
```
