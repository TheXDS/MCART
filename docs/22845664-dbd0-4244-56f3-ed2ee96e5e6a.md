# Colors.ColdGrey Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.ColdGrey"\]
...
**C#**<br />
``` C#
public static Color ColdGrey { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property ColdGrey As Color
	Get
```
