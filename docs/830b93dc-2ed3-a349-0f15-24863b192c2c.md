# Colors.SgiGray52 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray52"\]
...
**C#**<br />
``` C#
public static Color SgiGray52 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray52 As Color
	Get
```
