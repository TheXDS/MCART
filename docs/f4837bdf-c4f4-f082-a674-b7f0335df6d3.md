...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>Tipo del valor almacenado por esta instancia.</dd></dl>&nbsp;
The ValueChangingEventArgs(T) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="66579f05-6031-dbba-423a-9cdfc8e35107">ValueChangingEventArgs(T)</a></td><td>
Inicializa una nueva instancia de la clase ValueChangingEventArgs(T) con el valor provisto.</td></tr></table>&nbsp;
<a href="#valuechangingeventargs(*t*)-class">Back to Top</a>
...
Convierte implícitamente este ValueChangingEventArgs(T) en un <a href="99375f7a-b85c-b405-0819-7d2e3b04732b">ValueEventArgs(T)</a>.</td></tr></table>&nbsp;
<a href="#valuechangingeventargs(*t*)-class">Back to Top</a>
