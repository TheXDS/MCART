# TaskReporterControl.TStartPropertyKey Field
 _**\[This is preliminary documentation and is subject to change.\]**_

Llave de lectura/escritura para la propiedad de dependencia de sólo lectura <a href="79e27c9b-bfba-587f-086a-55487e1f0b1e">TStart</a>.
...
**C#**<br />
``` C#
protected static DependencyPropertyKey TStartPropertyKey
```

**VB**<br />
``` VB
Protected Shared TStartPropertyKey As DependencyPropertyKey
```
