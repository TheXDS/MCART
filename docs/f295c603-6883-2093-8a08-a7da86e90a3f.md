# Colors.CadmiumYellow Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.CadmiumYellow"\]
...
**C#**<br />
``` C#
public static Color CadmiumYellow { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property CadmiumYellow As Color
	Get
```
