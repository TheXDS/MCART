# Colors.SgiGray12 Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.SgiGray12"\]
...
**C#**<br />
``` C#
public static Color SgiGray12 { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property SgiGray12 As Color
	Get
```
