# Colors.Sgichartreuse Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:MCART.Resources.Colors.Sgichartreuse"\]
...
**C#**<br />
``` C#
public static Color Sgichartreuse { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Sgichartreuse As Color
	Get
```
