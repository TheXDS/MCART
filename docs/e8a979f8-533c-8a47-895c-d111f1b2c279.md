# NumberBoolConverter.ConvertBack Method 
 _**\[This is preliminary documentation and is subject to change.\]**_

Infiere un valor <a href="http://msdn2.microsoft.com/es-es/library/td2s409d" target="_blank">Int32</a>a partir de un <a href="http://msdn2.microsoft.com/es-es/library/a28wyd50" target="_blank">Boolean</a>.
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/es-es/library/e5kfa45b" target="_blank">Object</a><br />`-1` si *value* es `true`, `0` en caso contrario.
