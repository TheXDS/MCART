' ======================= M C A R T   C O N F I D E N C I A L =======================
'
' Este módulo contiene ejemplos de código para MCART, y no debe ser compilado ni
' incluido en ninguna distribución de MCART. Su propósito es el de brindar un espacio
' que permita la creación de documentación para compilar, por lo que el código
' contenido aquí no está pensado para su distribución o uso en un entorno de
' producción, sino más bien como una referencia a partir de la cual el desarrollador
' podrá aprender a utilizar la librería y crear su propio código.
' 
' Antes de compilar MCART, la propiedad "Acción de compilación" para este archivo
' debe establecerse en "Ninguna".
